...
export default async function Page() {
  return (
    ...
    //   </div>
    // </div>
    <div className="flex flex-col md:flex-row md:space-x-6 mb-24 lg:mb-0 mx-2 md:mx-0.5">
        ...
        {Array(4)
          ...
          .map((_, idx) => (
            ...
            >
              ...
              <div className="w-full px-2 lg:px-3 flex flex-col space-y-4 mt-2">
      ...
      <Skeleton className="rounded-md w-full md:w-[350px] lg:w-[400px h-56 mt-5 hidden lg:inline-block" />
    </div>
  );
}
